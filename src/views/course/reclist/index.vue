<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;">
      ...
      <el-table-column prop="icon" label="图片展示"/>
      <el-table-column prop="money" label="价格"/>
      <el-table-column prop="people" label="报名人数"/>
      <el-table-column prop="istop" label="是否停止"/>
      <el-table-column prop="claId" label="关联的详情id"/>
