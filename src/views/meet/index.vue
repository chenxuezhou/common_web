<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;">
      <el-table-column prop="userId" label="创建人用户id"/>
      <el-table-column prop="createTime" label="会议时间">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createTime) }}</span>
        </template>
      </el-table-column>
      <el-table-column prop="hostPer" label="会议主持人"/>
      <el-table-column prop="outPer" label="会议出席人"/>
