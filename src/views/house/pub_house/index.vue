<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;">
      ...
      <el-table-column prop="rentaltype" label="出租类型"/>
      <el-table-column prop="rentalperiodunit" label="起租单位"/>
      <el-table-column prop="rentalperiod" label="起租时间"/>
      <el-table-column prop="rentalprice" label="价格"/>
