<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" border style="width: 100%;">
      <el-table-column prop="name" label="教案名称"/>
      ...
      <el-table-column prop="createId" label="上传人编号"/>
      <el-table-column prop="createName" label="上传人姓名"/>
...
import { del } from '@/api/teaResource'
