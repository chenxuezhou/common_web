    ...
    <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增' : '编辑'" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
            ...
            <el-form-item label="考试开始时间" prop="startTime">
                <el-date-picker v-model="form.startTime" type="datetime" style="width: 370px;" placeholder="选择日期">
                </el-date-picker>

            </el-form-item>
            <el-form-item label="考试结束时间" prop="endTime">
                <el-date-picker v-model="form.endTime" type="datetime" style="width: 370px;" placeholder="选择日期">
                </el-date-picker>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        id: [{ required: true, message: "编号", trigger: "blur" }],

        time: [{ required: true, message: "作答时间", trigger: "blur" }],
        okScore: [{ required: true, message: "合格分", trigger: "blur" }],
        createId: [{ required: true, message: "出卷人编号", trigger: "blur" }],
        createName: [{ required: true, message: "出卷人名称", trigger: "blur" }]
      },
      options: []
    };
  },
