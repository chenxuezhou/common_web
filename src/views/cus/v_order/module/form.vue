<template>
  <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增' : '编辑'" width="500px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      <el-form-item label="订单总价" prop="num">
            <el-input v-model="form.num" style="width: 370px;"/>

      </el-form-item>
      <el-form-item label="详情集合id" prop="cdListId">
            <el-input v-model="form.cdListId" style="width: 370px;"/>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        cdListId: [
            {required: true,message:'详情集合id',trigger: 'blur'}
        ],
        cusId: [
